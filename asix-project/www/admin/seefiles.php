...
<div class='dropdown'>
  ...
  ?>
    ...
    if ($result->num_rows > 0) {
        echo "<table><tr><th>Name</th><th>Download link</th><th>ID USB</th><th>Analysis Report</th></tr>";
        // output data of each row
        while($row = $result->fetch_assoc()) {
            echo "<tr><td>".$row["nombre"]."</td><td><a href=".$row["direccion"]." download>Download</td><td>".$row["usb"]."</td><td><a href=".$row["report"].">Download report</td></tr>";
        }
        echo "</table>";
    } else {
        echo "0 results";
